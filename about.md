...
2025, so that's 22 years already. When I set up the blog initially it wasn't
to use it as a personal site. I was interested in mobile at the
time, and found the idea of read/write sites along with mobile to be a
particularly interesting intersection of evolving technologies. So I was
working on a mobile blogging client for the Palm series of devices, and I just
...
to remind myself of things that
got buried under years and years of new experiences. That's a pretty marginal
utility. Lots of the links are broken because the sites disappeared decades 
ago. And there's probably missing media, and maybe some messed up formatting
from when I moved this from Wordpress to different versions of static site
generation. I have gotten the odd ping from someone landing on one of the
posts and trying to dig up the old info. Unfortunately I don't have anything
more than what's up here. The best I can suggest is to use the links that are
still around to try to dig info out of the
[wayback machine](https://web.archive.org/). And if you do dig up something
useful maybe toss them a donation while you're there. Keeping some of this old
info alive is a labor of love, but not always easy.
